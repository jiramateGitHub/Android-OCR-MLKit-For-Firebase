...
class HistoryScanAdapter (val historyScans: ArrayList<TBM_ImagesQrCode>) : RecyclerView.Adapter<HistoryScanAdapter.ViewHolder> ()
{
    ...
    override fun onCreateViewHolder (p0 : ViewGroup, p1: Int) : ViewHolder {
        val v = LayoutInflater.from(p0.context).inflate(R.layout.recy_list_qrcode, p0, false)
        return ViewHolder(
            v
        )
    }
    ...
    override fun onBindViewHolder (p0 : ViewHolder, p1: Int){
        val historyScan : TBM_ImagesQrCode = historyScans [p1]
